	...
	<div class="page-area product-page spad">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<figure>
						<img class="product-big-img" src="{{ asset('uploads/products_photos') }}/{{$single_product_info->product_image}}" alt="">
					</figure>
				...
				<div class="col-lg-6">
					<div class="product-content">
						...
						<h6>Category Name : {{$single_product_info->relationTocategories->category_name}}</h6>
						<br />
						<div class="pc-meta">
				...
				@forelse($related_products as $related_product)
					<div class="col-lg-3">
						<div class="product-item">
							<figure>
								<img src="{{ asset('uploads/products_photos') }}/{{$related_product->product_image}}" alt="">
