			...
			<div class="row">
				<div class="col-lg-3 col-md-8 col-sm-12">
					<div class="footer-widget about-widget">
						...
						<div class="cards">
							<img src="{{asset('frontend_assets/img/cards/5.png')}}" alt="image not fount">
							<img src="{{asset('frontend_assets/img/cards/4.png')}}" alt="image not fount">
							<img src="{{asset('frontend_assets/img/cards/3.png')}}" alt="image not fount">
							<img src="{{asset('frontend_assets/img/cards/2.png')}}" alt="image not fount">
							<img src="{{asset('frontend_assets/img/cards/1.png')}}" alt="image not fount">
						</div>
					</div>
				</div>
