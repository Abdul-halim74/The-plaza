@extends('layouts.frontendapp')
				...
				<li>
					<div class="intro-item">
						<figure>
							...
							<img src="{{ asset('uploads/products_photos') }}/{{$product->product_image}}" alt="#">
							</a>
						</figure>
	...
	<h2 class="text-center mb-5"> <b> Product Catagories </b></h2>
		<div class="container">
			...
			@foreach($products as $product)
				<div class="mix col-lg-3 col-md-6 filter{{$product->category_id}}">
					<div class="product-item">
						<figure>
							<img src="{{ asset('uploads/products_photos') }}/{{$product->product_image}}" alt="not found">
							<div class="pi-meta">
								<div class="pi-m-left">
